...
export const wallet: Wallet = {
	address: makeCommandWithArgsOptsAndFlags('wallet', 'address'),
	attach: makeCommandWithArgsOptsAndFlags('wallet', 'attach'),
	create: makeCommandWithArgsOptsAndFlags('wallet', 'create'),
	destroy: makeCommandWithArgsOptsAndFlags('wallet', 'destroy'),
	detach: makeCommandWithArgsOptsAndFlags('wallet', 'detach'),
	help: makeCommandWithArgsOptsAndFlags('wallet', 'help'),
	list: makeCommandWithArgsOptsAndFlags('wallet', 'list'),
	log: makeCommandWithArgsOptsAndFlags('wallet', 'log'),
	recover: makeCommandWithArgsOptsAndFlags('wallet', 'recover'),
	statement: makeCommandWithArgsOptsAndFlags('wallet', 'statement'),
	status: makeCommandWithArgsOptsAndFlags('wallet', 'status'),
	sync: makeCommandWithArgsOptsAndFlags('wallet', 'sync'),
	utxos: makeCommandWithArgsOptsAndFlags('wallet', 'utxos'),
}
